    ...
    <div className="min-h-screen bg-gray-900 flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute top-1/2 left-1/3 w-80 h-80 bg-pink-400/15 rounded-full blur-[80px]"
        />
        ...
        <motion.div
          ...
          className="absolute -top-1/2 -right-1/2 w-[1000px] h-[1000px] border border-pink-500/10 rounded-full"
        />
        <motion.div
          animate={{
            rotate: [360, 0],
          ...
          className="absolute -bottom-1/2 -left-1/2 w-[1200px] h-[1200px] border border-pink-500/10 rounded-full"
        />
      </div>
          ...
          <div className="flex justify-between items-center h-16">
            ...
            >
              <motion.div
                ...
                className="w-10 h-10 bg-pink-600 rounded-xl flex items-center justify-center shadow-lg shadow-pink-500/50"
              >
              ...
              {user ? (
                ...
                <>
                  ...
                  <motion.button
                    ...
                    className="px-5 py-2.5 bg-pink-600 text-white rounded-lg font-semibold shadow-lg shadow-pink-500/30 hover:bg-pink-500 transition-all"
                    whileHover={{ 
                      scale: 1.05,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center max-w-5xl mx-auto">
            ...
            >
              <motion.button
                onClick={() => navigate('/signup')}
                className="relative px-12 py-5 bg-pink-600 text-white rounded-xl font-bold text-lg shadow-2xl shadow-pink-500/50 overflow-hidden group"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                <motion.div
            ...
            >
              {[
                ...
                <motion.div
                  ...
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.8, delay: 1.7 + stat.delay }}
                ...
                >
                  <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl border border-gray-700/50 hover:border-pink-500/50 transition-all duration-300 shadow-lg hover:shadow-pink-500/20">
                    <motion.div
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
                      transition={{ duration: 0.5, delay: 1.9 + stat.delay, type: "spring" }}
                  ...
                  {/* Hover glow effect */}
                  <motion.div
                    className="absolute inset-0 bg-pink-500/20 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10"
                  />
                </motion.div>
              ))}
            </motion.div>
